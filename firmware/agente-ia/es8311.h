...
private:
  ...
  static constexpr CoeffDiv kCoeffs[] = {
      ...
      // Radio MP3 (TuneIn): reloj ES8311 al sample rate del stream
      {6144000, 44100, 0x03, 0x01, 0x01, 0x01, 0x00, 0x02, 0xff, 0x04, 0x10, 0x10},
      {6144000, 48000, 0x03, 0x01, 0x01, 0x01, 0x00, 0x02, 0xff, 0x04, 0x10, 0x10},
      {6144000, 32000, 0x03, 0x01, 0x01, 0x01, 0x00, 0x01, 0xff, 0x04, 0x10, 0x10},
      // ESP32-audioI2S @ 48 kHz, MCLK = 48k * 256 = 12.288 MHz (tabla oficial ES8311)
